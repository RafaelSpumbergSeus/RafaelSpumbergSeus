# 📊 Rafael Spumberg - Analista de Dados | Cientista de Dados em Formação

Olá! Sou um profissional de TI apaixonado por tecnologia e análise de dados, com formação interdisciplinar que combina História, Museologia e Ciência de Dados. Minha abordagem une pensamento crítico, criatividade e habilidades técnicas para transformar dados em insights valiosos.
...
## 🚀 Projetos Destacados
-->
<!-- - [Análise de Dados de Varejo](https://github.com/RafaelSpumbergSeus/analise-varejo) - Análise completa de dataset de varejo usando Python e Pandas
  [//]: # - [Dashboard de Performance Comercial](https://github.com/RafaelSpumbergSeus/dashboard-comercial) - Dashboard interativo construído com Power BI
  [//]: # - [Modelagem de Banco de Dados para Museus](https://github.com/RafaelSpumbergSeus/modelagem-museus) - Projeto que une minha experiência em museologia com TI
-->
